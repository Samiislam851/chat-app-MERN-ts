...
const RequestedPersonCard = ({ requestedPerson, dbUser, setDbUser, requestedPersons, setRequestedPersons }: Props) => {
    ...
    return (
        <div className=' flex items-center justify-between border-t border-gray-600 bg-white bg-opacity-15 border-s  p-2 backdrop-blur-[2px]  rounded-lg mt-2  hover:-me-5 transition-all ease-in-out  duration-300  '>
